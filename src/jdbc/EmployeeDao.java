...
public class EmployeeDao {
	...
	public EmployeeDao ( String url, String user, String password ) throws ClassNotFoundException, SQLException {
	...
	private void connect ( String url, String user, String password ) throws ClassNotFoundException, SQLException  {
	...
	private static void printResultSetBody ( ResultSet rs )
			throws SQLException {
